<ul class="menu">
	<li class="top"><a href="#" class="top_link"><span><?=$this->lang->line('menu_system_title');?></span></a>
		<ul class="sub">
			...
			<!--<li><a href="<?=site_url();?>admin/modulos"><?=$this->lang->line('menu_system_modules');?></a></li>-->
	...
	<li class="top"><a href="#" class="top_link"><span>Páginas</span></a>
		<ul class="sub">
			<li><a href="<?=site_url();?>admin/paginas/1/80a42656db84020be8e425171db1f757/">A Empresa</a></li>
			<li><a href="<?=site_url();?>admin/paginas/2/c6eba2bb0b1c1e6ad17dc3076b5f5826/">Serviços</a></li>
		</ul>
	</li>
</ul>
