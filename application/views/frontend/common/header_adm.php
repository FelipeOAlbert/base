...
<head>
	...
	<meta name="author" content="WAD Tecnologia">
	...
	<!-- Javascripts -->
	<script type="text/javascript" src="<?=site_url();?>resources/js/jquery-1.6.2.min.js"></script>
...
<body onload="init('<?=site_url();?>');">
	...
	<div id="top">
		<div class="logo">Admin Fenlis</div>
